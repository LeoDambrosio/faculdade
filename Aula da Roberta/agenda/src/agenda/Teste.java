...
public class Teste {
    public static void main(String[] args) {
        ...
        System.out.println("Digite o nome do arquivo (ex: agenda.txt):");
        ...
        do {
            ...
            System.out.println("5. Buscar por Parte do Nome");
            System.out.println("6. Editar por Telefone");
            System.out.println("7. Excluir por Telefone");
            System.out.println("8. Listar Ordenado");
            System.out.println("9. Exportar Backup");
            System.out.println("10. Listar Arquivos");
            System.out.println("11. Trocar de Arquivo");
            ...
            switch (opcao) {
                case 1 -> {
                    ...
                    if (persistencia.contatoJaExiste(c.getNome())) {
                        System.out.println("Contato ja existe! Operação cancelada.");
                        break;
                    }
                ...
                case 5 -> {
                    System.out.print("Nome para edicao inteligente: ");
